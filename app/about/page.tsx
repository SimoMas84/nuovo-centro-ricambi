              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-lg text-text-muted leading-relaxed">
                  <p>
                    ...
                    riferimento per ricambi di veicoli commerciali e
                    industriali.
                  </p>
                  <p>
                    Con oltre{" "}
                    ...
                    , abbiamo costruito relazioni solide con i migliori
                    fornitori e produttori di ricambi, garantendo ai nostri
                    clienti prodotti di altissima qualità a prezzi competitivi.
                  </p>
                  <p>
                    ...
                    sempre disponibili, con un sistema logistico efficiente che
                    ci permette di soddisfare rapidamente ogni esigenza.
                  </p>
                  <p>
            ...
            {values.map((value: Value, index: number) => {
              ...
              return (
                <FadeIn key={value.title} delay={index * 0.1}>
                  <div className="p-8 text-center hover:shadow-xl transition-shadow duration-300 border border-border bg-background rounded-lg h-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <FadeIn direction="right">
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-lg text-text-muted leading-relaxed">
                  <p>
                    Il successo di NCR è il risultato del lavoro appassionato
                    del nostro team di professionisti qualificati.
                  </p>
                  <p>
                    Ogni membro del nostro staff possiede una profonda
                    conoscenza tecnica e una lunga esperienza nel settore dei
                    veicoli commerciali, permettendoci di offrire consulenze
                    specializzate e soluzioni personalizzate.
                  </p>
                  <p>
